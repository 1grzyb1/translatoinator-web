<footer class="footer bg-white relative border-t-2 border-gray-300 mt-40">
    <div class="container mx-auto px-6">
        <div class="mt-6 grid grid-cols-6">
            <div class="sm:w-2/3 text-left col-span-5">
                <p class="text-sm text-gray-700 font-bold mb-2">
                    © 2021 by grzybek
                </p>
            </div>
            <div class="space-x-4">
                <a aria-label="Github" href="https://github.com/1grzyb1" class="inline-block">
                ...
                <a aria-label="Linkedin" href="https://www.linkedin.com/in/wiktor-keska/" class="inline-block">
                    <div class="text-gray-800 dark:text-gray-50 cursor-pointer hover:text-brand dark:hover:text-brand">
